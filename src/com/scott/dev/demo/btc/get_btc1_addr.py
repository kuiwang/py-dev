...
ADDR_URL_PREFIX = "https://privatekeys.pw/bitcoin-segwit/keys/{}"
logger = logging.getLogger('get_btc1_addr')
LOG_FILE = 'get_btc1_addr.log'
...
def parseBtc1AddrPage(page, url):
    ...
    for tr in tr_lst:
        ...
        #log format: page_num|priv_key_hex|compressed_addr_prefix_btc1|uncompress_addr_prefix_btc1
        logger.info("{}|{}|{}|{}".format(str(page), str(priv_key_hex), str(compress_addr), str(uncompress_addr)))


def saveBtc1AddrInfo():
    logger.info("saveBtc1AddrInfo start")
    #i = 20708
    #i = 1
    #i = 891
    #i = 29596
