...
logger = logging.getLogger('get_addr_by_hex_continue')
LOG_FILE = 'get_addr_by_hex_continue.log'
RECORD_NUM = 45
...
def saveSimpleAddrInfo():
    ...
    #page = 1
    i = 0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd02ac9d7
    while(i >= 1):
        s_hex = "%064x" % i
        '''
...
if __name__ == '__main__':
    ...
    '''
    i = 115792089237316195423570985008687907852837564279074904382605163141518161494336
    origin = 'fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364140'
    ssssss = 'fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364140'
    s_hex = "%064x" % i
    print (s_hex)
    '''
