...
logger = logging.getLogger('get_addr_by_hex')
LOG_FILE = 'get_addr_by_hex.log'
RECORD_NUM = 45
...
def gen_address_by_hex(page, i):
    ...
    while not valid_private_key:
        ...
        logger.info('{}|{}|{}|{}|{}|{}|{}|{}|{}|{}'.
                    format(str(page), str(priv_hex_param), 
