...
logger = logging.getLogger('greatapp')
LOG_FILE = 'greatapp_crawl.log'
...
def post_url(url):
    try:
        HEADER_UA = "Beauty/1.0 (iPhone; iOS 12.1.4; Scale/2.00)"
        HEADER_ACCEPT_ENCODING = "gzip, deflate"
        HEADER_Accept_Language = "zh-Hans-CN;q=1, en-CN;q=0.9, zh-Hant-CN;q=0.8"
        HEADER_HOST = 'zzns.prettybeauty.biz'
        HEADER_COOKIE = "PHPSESSID=bp9j0ro3vs7tn04r43uh20lop7"
        header = {"User-Agent":HEADER_UA, "HOST":HEADER_HOST, "COOKIE":HEADER_COOKIE, "Accept-Language":HEADER_Accept_Language, "Accept-Encoding":HEADER_ACCEPT_ENCODING}
...
def test():
    app_great_url = 'http://108.61.200.217/album/all?app=Znns&it=1552895392&pageIndex=1&pageSize=10&styleId=0&type=0&version=1.0'
    app_fantastic_url = "http://45.32.91.83/album/all?app=Fantastic&it=1552895379&pageIndex=1&pageSize=10&styleId=0&type=1&version=1.8"
    app_meitu_url = "http://45.32.91.83/album/all?app=Rosi&it=1552895727&pageIndex=1&pageSize=10&styleId=0&type=1&version=1.0"
    ts = round(time.time())
    # url = "http://108.61.200.217/album/all?app=Znns&it=" + str(ts) + "&pageIndex=1&pageSize=1000&styleId=0&type=0&version=1.0"
    cont = post_url(app_great_url)
    logger.info(cont)
