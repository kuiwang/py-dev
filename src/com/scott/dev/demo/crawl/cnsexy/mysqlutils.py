...
def connect_mysql():
    ...
    try:
        ...
        with open(config, "r") as file:
            ...
            h = load_dict['database']['cnsxy']['host']
            u = load_dict['database']['cnsxy']['user']
            p = load_dict['database']['cnsxy']['password']
            port = load_dict['database']['cnsxy']['port']
            cs = load_dict['database']['cnsxy']['charset']
            db = load_dict['database']['cnsxy']['db']
